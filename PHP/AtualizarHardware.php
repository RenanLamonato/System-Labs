...
#verefica se o arquivo foi chamado a partir de um formulario
            $nomeS = isset($_POST["FormNomeHardware"])?$_POST["FormNomeHardware"]:"Nome do Software não informado"; 
    ...
    $sql = "UPDATE Hardware SET nome_Hardware ='".$nomeS."', Versao='".$ver."', descricao='".$des."' WHERE id_Hardware =".$cod."";
...
<br><a href="mostrarDadosBancoHardware.php">Clique aqui para mostrar os valores em registro</a>
