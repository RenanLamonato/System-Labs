...
if (!$link) {
    ...
    exit;
            ...
            $nomeS = isset($_POST["FormNomeHardware"])?$_POST["FormNomeHardware"]:"Nome do Hardware não informada"; 
    ...
    $sql = "INSERT INTO Hardware(nome_Hardware,Versao,descricao)VALUES('".$nomeS."','".$ver."', '".$des."')";
