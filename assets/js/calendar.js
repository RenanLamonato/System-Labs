document.addEventListener('DOMContentLoaded', function() {
    ...
    function idbotao(idb){
       document.getElementById('idaux').value = idb;
    }
    
    
     formData = new FormData();
    $("#tconfres").click(function(e){
        var confRes = document.getElementById("confRes");
        var idRes = document.getElementById("idaux");
        formData.append("confRes",confRes.value);
        formData.append("idaux",idRes.value);
        window.location.reload();

        var xmlhttp = new XMLHttpRequest(); 
        xmlhttp.onreadystatechange=function() {};
        xmlhttp.open("POST","http://localhost:8080/System-Labs/Solicitacao/alterarEstado",true);
        xmlhttp.send(formData);
        
        
//console.dir(this.dataset.url);
//        $.ajax({
//            type: 'POST',
//            url: 'http://localhost:8080/System-Labs/Solicitacao/alterarEstado/'
//
//            complete: function (retorno) {
//                if(retorno.responseText==='1'){
//                    $('.modal').modal('hide');
...
//         var slider = document.getElementById("confRes");
//var output = document.getElementById("demo");
//output.innerHTML = slider.value;
//slider.oninput = function() {
//  output.innerHTML = this.value;
//          var inf = document.getElementById('confRes').value;
//    document.getElementById('custId').value = inf;
//}
});
