...
<?php  $result = mysqli_query($link, $sql);
    ...
    ?>
            ...
            <div id="ladoDireito">
                <h1>Adcionar software</h1>
                <form method="POST" action="PHP/adcionarBancoSoftware.php?">
                    <center>
            <table>
                <tr>
                    <td>Nome do Software:</td>
                    <td>
                        <input name="FormNomeSoftware" maxlength="100">
                    </td>
                </tr>
                <tr>
                    <td>versão:</td>
                    <td>
                        <input name="FormVersao" maxlength="10">
                    </td>
                </tr>
                <tr>
                    <td>Descrição:</td>
                ...
                <td colspan="2" align="right">
                    ...
                    <br><a href="PHP/mostrarDadosBancoSoftware.php"><b>Clique aqui para mostrar os valores em registro e os atualizar</b></a>
